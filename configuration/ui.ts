...
export const CHAT_HEADER: string = `Milo AI`;
export const MESSAGE_PLACEHOLDER: string = `Hello! I'm an AI assistant created to help you.`;
export const FOOTER_MESSAGE: string = `Created by Charles Shew`;
export const CLEAR_BUTTON_TEXT: string = `Clear Chat`;
export const PAGE_TITLE: string = `Milo AI`;

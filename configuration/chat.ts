...
export const WORD_CUTOFF: number = 15000; // Number of words until bot says it needs a break
export const WORD_BREAK_MESSAGE: string = `I've reach my word limit and need to take a break`;
